...
$.getJSON("./store-password"), function(data){
  var auth = data
}
//var driver = neo4j.driver("bolt://localhost", neo4j.auth.basic(auth.users.name, auth.users.password));
var driver = neo4j.driver('neo4j://localhost', neo4j.auth.basic('neo4j', 'ptut2020'));
